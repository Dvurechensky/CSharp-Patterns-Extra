...
public class Bird
{
    ...
    //Метод отвечающий за конкретное действие
    private void Fly()
    {
        speed = 1;
        switch(rand.Next(2))
    ...
    //Метод отвечающий за сам факт движения(ибо есть птицы которые могут летать, а есть птицы которые могут бегать и плавать)
...
//Теперь в наследнице класса мы можем сделать бегающцю птичку удалив метод Fly
...
//Класс занимающийся отображением полета
